...
#ifndef __ODSQ6_HPP__
#define __ODSQ6_HPP__
...
namespace pmrrr { namespace lapack {
	...
	int odsq6(int *i0, int *n0, FloatingType *z__, 
		int *pp, FloatingType *dmin__, FloatingType *dmin1, FloatingType *dmin2, 
		 FloatingType *dn, FloatingType *dnm1, FloatingType *dnm2)
	{
