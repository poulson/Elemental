...
namespace pmrrr { namespace lapack {
	...
	int odrrd(char *range, char *order, int *n, FloatingType *vl,  
		...
		FloatingType *w, FloatingType *werr, FloatingType *wl, FloatingType *wu, 
		...
		int *info)
	{
		...
		FloatingType atoli;
		int iwoff, itmax;
		FloatingType wkill, rtoli, uflow, tnorm;
		// extern FloatingType dlamch_(char *);
		int ibegin;
