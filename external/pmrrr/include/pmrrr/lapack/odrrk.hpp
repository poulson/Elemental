...
namespace pmrrr { namespace lapack {
	...
	int odrrk(int *n, int *iw, FloatingType *gl, 
		FloatingType *gu, FloatingType *d__, FloatingType *e2, FloatingType *pivmin, 
		FloatingType *reltol, FloatingType *w, FloatingType *werr, int *info)
	{
		...
		/* Local variables */
		int i__, it;
		FloatingType mid, eps, tmp1, tmp2, left, atoli, right;
		int itmax;
		FloatingType rtoli, tnorm;
