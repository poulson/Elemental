...
#include <pmrrr/lapack/odset.hpp>
...
namespace pmrrr { namespace lapack {
	...
	int odrrv(int *n, FloatingType *vl, FloatingType *vu, 
		FloatingType *d__, FloatingType *l, FloatingType *pivmin, int *isplit, 
		int *m, int *dol, int *dou, FloatingType *minrgp, 
		FloatingType *rtol1, FloatingType *rtol2, FloatingType *w, FloatingType *werr, 
		 FloatingType *wgap, int *iblock, int *indexw, FloatingType *gers, 
		...
		int *iwork, int *info)
	{
		...
		/* Builtin functions */
		// FloatingType log(FloatingType);

		/* Local variables */
		int minwsize, i__, j, k, p, q, miniwsize, ii;
		FloatingType gl;
		int im, in;
		FloatingType gu, gap, eps, tau, tol, tmp;
		int zto;
		FloatingType ztz;
		int iend, jblk;
		FloatingType lgap;
		int done;
		FloatingType rgap, left;
		int wend, iter;
		FloatingType bstw;
		int itmp1;
	...
	//	    FloatingType *, int *);
		...
		int needbs;
		int indlld;
		FloatingType sgndef, mingma;
		//extern /* Subroutine */ int odrrb_(int *, FloatingType *, FloatingType *, 
			/* int *, int *, FloatingType *, FloatingType *, int *, 
			FloatingType *, FloatingType *, FloatingType *, FloatingType *, int *, 
			 FloatingType *, FloatingType *, int *, int *);*/
		int oldien, oldncl, wbegin;
		FloatingType spdiam;
		int negcnt;
		//extern /* Subroutine */ int odrrf_(int *, FloatingType *, FloatingType *, 
