...
#ifndef __ODEBZ_HPP__
#define __ODEBZ_HPP__
...
namespace pmrrr { namespace lapack {
	...
	int odebz(int *ijob, int *nitmax, int *n, 
		int *mmax, int *minp, int *nbmin, FloatingType *abstol, 
		FloatingType *reltol, FloatingType *pivmin, FloatingType *d__, FloatingType *
		e, FloatingType *e2, int *nval, FloatingType *ab, FloatingType *c__, 
		int *mout, int *nab, FloatingType *work, int *iwork, 
		int *info)
	{
		/* System generated locals */
		int nab_dim1, nab_offset, ab_dim1, ab_offset, i__1, i__2, i__3, i__4, 
			i__5, i__6;
		FloatingType d__1, d__2, d__3, d__4;

		/* Local variables */
		int j, kf, ji, kl, jp, jit;
		FloatingType tmp1, tmp2;
