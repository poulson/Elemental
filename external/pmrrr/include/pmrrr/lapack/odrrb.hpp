...
#ifndef __ODRRB_HPP__
#define __ODRRB_HPP__
...
namespace pmrrr { namespace lapack {
	...
	int odrrb(int *n, FloatingType *d__, FloatingType *lld, 
		int *ifirst, int *ilast, FloatingType *rtol1, FloatingType *rtol2, 
		 int *offset, FloatingType *w, FloatingType *wgap, FloatingType *werr, 
		FloatingType *work, int *iwork, FloatingType *pivmin, FloatingType *
