...
#ifndef __ODSQ5_HPP__
#define __ODSQ5_HPP__
...
namespace pmrrr { namespace lapack {
	...
	int odsq5(int *i0, int *n0, FloatingType *z__, 
		int *pp, FloatingType *tau, FloatingType *dmin__, FloatingType *dmin1, 
		FloatingType *dmin2, FloatingType *dn, FloatingType *dnm1, FloatingType *dnm2, 
		 int *ieee)
	{
