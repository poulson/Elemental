...
#include <pmrrr/lapack/ode2.hpp>
#include <pmrrr/lapack/odev2.hpp>
#include <pmrrr/lapack/odrrv.hpp>
...
namespace pmrrr { namespace lapack {
	...
	{
		/* Moved here to include floating type type */
	...
	/*           WANTZ .EQ. FALSE. */
		...
		if (zquery && *info == 0) {
			z__[z_dim1 + 1] = (FloatingType) nzcmin;
