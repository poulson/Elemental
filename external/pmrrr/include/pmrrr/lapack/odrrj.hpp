/**
	C++ template version of LAPACK routine dlarrj.
	Based on C code translated by f2c (version 20061008).
*/

#ifndef __ODRRJ_HPP__
#define __ODRRJ_HPP__
...
namespace pmrrr { namespace lapack {
	...
	int odrrj(int *n, FloatingType *d__, FloatingType *e2, 
		int *ifirst, int *ilast, FloatingType *rtol, int *offset, 
		FloatingType *w, FloatingType *werr, FloatingType *work, int *iwork, 
		FloatingType *pivmin, FloatingType *spdiam, int *info)
	{
		...
		FloatingType s;
		int i1, i2, ii;
		FloatingType fac, mid;
		int cnt;
		FloatingType tmp, left;
		int iter, nint, prev, next, savi1;
		FloatingType right, width, dplus;
		int olnint, maxitr;
