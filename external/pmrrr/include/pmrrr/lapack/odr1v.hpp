...
namespace pmrrr { namespace lapack {
	...
	int odr1v(int *n, int *b1, int *bn, FloatingType 
		*lambda, FloatingType *d__, FloatingType *l, FloatingType *ld, FloatingType *
		lld, FloatingType *pivmin, FloatingType *gaptol, FloatingType *z__, int 
		*wantnc, int *negcnt, FloatingType *ztz, FloatingType *mingma, 
		int *r__, int *isuppz, FloatingType *nrminv, FloatingType *resid, 
		FloatingType *rqcorr, FloatingType *work)
	{
